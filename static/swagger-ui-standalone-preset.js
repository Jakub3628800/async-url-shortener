  ...
  return (function (t) {
            ...
            : "string" == typeof e
              ...
              : (function (t, e) {
                  if (a.isBuffer(e)) {
                    var n = 0 | h(e.length);
                    return (
                      0 === (t = s(t, n)).length || e.copy(t, 0, 0, n),
                      t
                    );
                  }
                  if (e) {
    ...
    function (t, e, n) {
      ...
      t.exports = function () {
        ...
        try {
          return (
            Date.prototype.toString.call(r(Date, [], function () {})),
            !0
          );
        } catch (t) {
          return !1;
      ...
      var r = n(1),
        ...
        ft = function (t, e) {
          ...
          if (n !== G || !l(H, r) || l(K, r)) {
            var i = J(n, r);
            return (
              !i || !l(H, r) || (l(n, P) && n[P][r]) || (i.enumerable = !0),
              i
            );
          }
        },
      ...
      (a ||
        (D(
          (W = function () {
            ...
            return (
              s && rt && it(G, e, { configurable: !0, set: n }),
              ot(e, t)
            );
          }).prototype,
          "toString",
            ...
            : 0 === e
              ? function () {
                  ...
                  if (hasOwnProperty.call(I, "data"))
                    return (
                      x && u.emit("get", "data", arguments, this),
                      I.data
                    );
                  if (
                    ((e = arguments.length
    ...
    function (t, e, n) {
      ...
      var I = {
        ...
        TAG: function (t, e, n) {
          var r, i;
          (2 !== n.length &&
            S(t, "TAG directive accepts exactly two arguments"),
            (r = n[0]),
            (i = n[1]),
            p.test(r) ||
              S(
